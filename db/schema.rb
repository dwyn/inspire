...
ActiveRecord::Schema.define(version: 2019_07_29_232652) do
  ...
  create_table "project_sections", force: :cascade do |t|
    ...
    t.index ["section_id"], name: "index_project_sections_on_section_id"
  end
  ...
  add_foreign_key "project_sections", "sections"
